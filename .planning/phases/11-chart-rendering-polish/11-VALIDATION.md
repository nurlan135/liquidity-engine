...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 11-01-01 | 01 | 1 | CHRT-01, CHRT-02 | — | N/A (canvas sizing/DPR options only; no user input, no auth, no crypto) | type + suite | `npx tsc --noEmit` + `npm test` | ✅ existing | ⬜ pending |
