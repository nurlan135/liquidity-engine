...
- [ ] **Phase 6: Dual-Symbol Proxy + Data Contracts** - Parameterized ES=F + intraday proxy with per-symbol stale envelopes and timestamp join
...
| 6. Dual-Symbol Proxy + Data Contracts | v2.0 | 0/TBD | Not started | - |
