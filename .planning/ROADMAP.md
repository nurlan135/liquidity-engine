...
- [x] 08-01-PLAN.md — Tracer: conforming 19:00→20:00 edits plus Asia Range core with DST triple-test
...
- [x] 08-03-PLAN.md — AMD phase classifier plus end-to-end fusion and full-suite green
...
- [x] 09-02-PLAN.md — Presentation: live §3 sub-blocks plus conviction line plus Asia lines plus Judas/SMT markers
