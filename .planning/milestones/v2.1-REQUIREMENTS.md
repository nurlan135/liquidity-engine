# Requirements Archive: v2.1 Cleanup & Polish
...
- [x] **CHRT-01**: Chart renders crisply on high-DPI (Retina) displays — no blur from devicePixelRatio mismatch
- [x] **CHRT-02**: Chart redraws cleanly on window/container resize — no stretched, clipped, or frozen canvas
...
| CHRT-01 | Phase 11 | Complete |
| CHRT-02 | Phase 11 | Complete |
